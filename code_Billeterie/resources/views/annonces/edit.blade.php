...
<div class="card">
    <div class="card-body">
        <form class="space-y-5" action="{{ route('annonces.update', $annonce->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            ...
            <div class="flex flex-wrap -mx-3">
                <div class="w-full px-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="objet_marche" class="form-input @error('objet_marche') is-invalid @enderror" value="{{ old('objet_marche', $annonce->objet_marche) }}" required>
                        @error('objet_marche')
                ...
                <div class="w-full md:w-1/3 px-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="nom_autorite_contractante" class="form-input @error('nom_autorite_contractante') is-invalid @enderror" value="{{ old('nom_autorite_contractante', $annonce->nom_autorite_contractante) }}" required>
                ...
                <div class="w-full md:w-1/3 px-3">
                    <div class="form-group">
                        <label for="lieu_depot">{{ __('Lieu de Dépôt') }} <span class="text-red-500">*</span></label>
                        <input type="text" name="lieu_depot" class="form-input @error('lieu_depot') is-invalid @enderror" value="{{ old('lieu_depot', $annonce->lieu_depot) }}" required>
                        @error('lieu_depot')
                        <div class="bg-red-500 text-white text-sm font-bold px-4 py-2 rounded">
                            {{ $message }}
                        </div>
                ...
                <div class="w-full md:w-1/3 px-3">
                    <div class="form-group">
                        ...
                        @if($annonce->image_autorite_contractante)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $annonce->image_autorite_contractante) }}" alt="{{ __('Image Autorité Contractante') }}" style="max-width: 200px;">
                            </div>
                        @endif
                ...
                <div class="w-full px-3">
                    <div class="form-group">
                        ...
                        <textarea name="adresse_autorite_contractante" class="form-input @error('adresse_autorite_contractante') is-invalid @enderror">{{ old('adresse_autorite_contractante', $annonce->adresse_autorite_contractante) }}</textarea>
                ...
                <div class="w-full md:w-1/3 px-3">
                    <div class="form-group">
                        ...
                        <input type="date" name="date_depot" class="form-input @error('date_depot') is-invalid @enderror" value="{{ old('date_depot', $annonce->date_depot) }}">
                        @error('date_depot')
                        <div class="bg-red-500 text-white text-sm font-bold px-4 py-2 rounded">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="flex items-center space-x-4 mt-2">
                            <label class="flex items-center">
                                <input type="radio" name="sourcesfinance" class="form-radio h-5 w-5 rounded-full text-blue-600" value="{{$sourcefinance[0]->id }}" {{ (old('sourcesfinance', $sourcefinance[0]->id) == $annonce->sourcesfinance_id) ? 'checked' : '' }}>
                                <span class="ml-2">{{$sourcefinance[0]->name}}</span>
                            </label>
                            <label class="flex items-center">
                                <input type="radio" id="sourcesfinance_id" name="sourcesfinance" class="form-radio h-5 w-5 rounded-full text-blue-600" value="{{$sourcefinance[1]->id }}" {{ (old('sourcesfinance', $sourcefinance[1]->id) == $annonce->sourcesfinance_id) ? 'checked' : '' }}>
                                <span class="ml-2">{{$sourcefinance[1]->name}}</span>
                            </label>
                            <label class="flex items-center">
                                <input type="radio" id="autres" name="sourcesfinance" class="form-radio h-5 w-5 rounded-full text-blue-600" value="{{$sourcefinance[2]->id}}" {{ (old('sourcesfinance', $sourcefinance[2]->id) == $annonce->sourcesfinance_id) ? 'checked' : '' }}>
                ...
                <div class="w-full md:w-1/2 px-3">
                    <div class="form-group" id="autre-div" style="{{ (old('sourcesfinance', $sourcefinance[2]->id) == $annonce->sourcesfinance_id) ? 'display: block;' : 'display: none;' }}">
                        <label for="autres">{{ __('Autres') }}</label>
                        <input type="text" name="autres" class="form-input @error('autres') is-invalid @enderror" value="{{ old('autres', $annonce->autres_source ) }}" placeholder="Entrez votre source de finance">
                        @error('autres')
                        <div class="bg-red-500 text-white text-sm font-bold px-4 py-2 rounded">
                            {{ $message }}
                        </div>
                ...
                <div class="w-full md:w-1/2 px-3">
                    <div class="form-group" id="category-div" style="{{ (old('sourcesfinance', $sourcefinance[1]->id) == $annonce->sourcesfinance_id) ? 'display: block;' : 'display: none;' }}">
                ...
                <div class="w-full md:w-1/2 px-3">
                    <div class="form-group">
                        ...
                        @if($annonce->ficher_annonce)
                            <div class="mb-2">
                                <a href="{{ asset('storage/' . $annonce->ficher_annonce) }}" target="_blank" class="text-primary hover:underline">{{ __('Voir le fichier existant') }}</a>
                            </div>
                        @endif
                        <input type="file" name="ficher_annonce" class="form-input @error('ficher_annonce') is-invalid @enderror" >
                ...
                <div class="w-full md:w-1/2 px-3">
                    <div class="form-group">
                        ...
                        <div class="relative">
                            <input type="text" id="datetimepicker" name="date_cloture" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:border-blue-300" placeholder="Sélectionner la date et l'heure" value="{{ old('date_cloture', $annonce->date_cloture) }}">
