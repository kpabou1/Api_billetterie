...
@section('title', __('Créer l\' Activite Principale'))
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">{{__('Créer l\' Activite Principale')}}</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{__('Dashboard')}}</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('activite_principales.index') }}">{{__('Activite Principales')}}</a></li>
                    <li class="breadcrumb-item active">{{__('Créer l\' Activite Principale')}}</li>
                </ol>
            </div>
        </div>
    </div>
