...
@section('title', __('Create Activite Principale'))
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('activite_principales.store') }}" method="POST">
            @csrf
            ...
            <button type="submit" class="btn btn-primary">{{ __('Create Activite Principale') }}</button>
        </form>
    </div>
</div>
