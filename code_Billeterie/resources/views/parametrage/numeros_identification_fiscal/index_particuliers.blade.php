...
@section('title')
    {{ __("Numéros d'Identification Fiscale - Particuliers") }}
@endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Liste des Numéros d'Identification Fiscale des Particuliers</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Tableau de bord</a></li>
                        <li class="breadcrumb-item active">Numéros d'Identification Fiscale - Particuliers</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            table = $('#numeros_identification_fiscal-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('numeros_identification_fiscal.index_particuliers') }}",
                columns: [
                    { data: 'id', name: 'id' },
                    { data: 'nif', name: 'nif' },
