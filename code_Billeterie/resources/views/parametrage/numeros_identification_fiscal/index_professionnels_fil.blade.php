    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Liste des Numéros d'Identification Fiscale des Professionnels - Filiales</h4>
        ...
        <table class="table table-striped table-bordered" id="numeros_identification_fiscal-table">
            <thead class="table-light">
                <tr>
                    ...
                    <th scope="col">Nom Filiale</th>
                    <th scope="col">Numéros Télephone </th>
                    <th scope="col">Email Filiale</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            table = $('#numeros_identification_fiscal-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('numeros_identification_fiscal.index_professionnels_fil') }}",
                columns: [
                    { data: 'id', name: 'id' },
                    { data: 'nif', name: 'nif' },
                    ...
                    {
                        data: 'filiale.nom_filiale',
                        name: 'filiale.nom_filiale',
                        defaultContent: ''
                    },
                    {
                        data: 'filiale.numero_telephone_filiale',
                        name: 'filiale.numero_telephone_filiale',
                        defaultContent: ''
                    },
                   
                    {
                        data: 'filiale.email_filiale',
                        name: 'filiale.email_filiale',
                        defaultContent: ''
                    },
