    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Liste des Numéros d'Identification Fiscale des Professionnels</h4>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            table = $('#numeros_identification_fiscal-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('numeros_identification_fiscal.index_professionnels') }}",
                columns: [
                    { data: 'id', name: 'id' },
                    { data: 'nif', name: 'nif' },
                    ...
                    {
                        data: 'professionnel.user.lastname',
                        name: 'professionnel.user.lastname',
                        defaultContent: ''
                    },
                    {
                        data: 'professionnel.user.firstname',
                        name: 'professionnel.user.firstname',
                        defaultContent: ''
                    },
