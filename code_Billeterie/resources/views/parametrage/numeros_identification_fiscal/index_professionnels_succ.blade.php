...
@section('title')
    {{ __("Numéros d'Identification Fiscale - Professionnels") }}
@endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Liste des Numéros d'Identification Fiscale des Professionnels - Succursales</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Tableau de bord</a></li>
                        <li class="breadcrumb-item active">Numéros d'Identification Fiscale - Professionnels</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <table class="table table-striped table-bordered" id="numeros_identification_fiscal-table">
            <thead class="table-light">
                <tr>
                    ...
                    <th scope="col">Nom Commercial Mère</th>
                    <th scope="col">Nom Succursale</th>
                    <th scope="col">Numéros Télephone Succursale</th>
                    <th scope="col">Email Succursale</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            table = $('#numeros_identification_fiscal-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('numeros_identification_fiscal.index_professionnels_succ') }}",
                columns: [
                    { data: 'id', name: 'id' },
                    { data: 'nif', name: 'nif' },
                    ...
                    {
                        data: 'professionnel.nom_commercial',
                        name: 'professionnel.nom_commercial',
                        defaultContent: ''
                    },
                    {
                        data: 'succursale.nom_commercial_succursale',
                        name: 'succursale.nom_commercial_succursale',
                        defaultContent: ''
                    },
                    {
                        data: 'succursale.numero_telephone_succursale',
                        name: 'succursale.numero_telephone_succursale',
                        defaultContent: ''
                    },
                   
                    {
                        data: 'succursale.email_succursale',
                        name: 'succursale.email_succursale',
                        defaultContent: ''
                    },
