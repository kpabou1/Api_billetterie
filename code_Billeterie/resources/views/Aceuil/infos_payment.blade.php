                    ...
                    <div class="card-body">
                        ...
                        <form id="paymentForm" action="{{ route('payments.inofs') }}" method="POST">
                            ...
                            <div hidden class="form-group">
                                ...
                                <input type="text" class="form-control @error('ticket_type_id') is-invalid @enderror"
                                    id="ticket_type_id" name="ticket_type_id" value="{{ $tickets[0]->ticket_type_id }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('order_intent_type') is-invalid @enderror"
                                    id="order_intent_type" name="order_intent_type">
                                    <option value="en_ligne" {{ old('order_intent_type') == 'en_ligne' ? 'selected' : '' }}>
                                        Commande en ligne</option>
                                    <option value="sur_place"
                                        {{ old('order_intent_type') == 'sur_place' ? 'selected' : '' }}>Commande sur place
                                    </option>
                                </select>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="number"
                                    class="form-control @error('order_intent_nombre') is-invalid @enderror"
                                    id="order_intent_nombre" name="order_intent_nombre"
                                    value="{{ old('order_intent_nombre') }}" placeholder="Entrez le nombre de tickets"
                                    required>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item"><strong>Adresse:</strong> {{ $event->event_address }},
                                {{ $event->event_city }}</li>
                        </ul>
                    </div>
